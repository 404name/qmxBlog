(function (h) {
    ...
    n.defaults = {
        ...
        oLanguage: {
            ...
            sEmptyTable: "暂无数据",
            sInfo: "显示 _START_ 到 _END_ 的数据 （共计 _TOTAL_ 条数据）",
            sInfoEmpty: "显示 0 到 0 （共有 0 条数据）",
            sInfoFiltered: "(已从 _MAX_ 个数据中搜索过滤出)",
            sInfoPostFix: "",
            sDecimal: "",
            sThousands: ",",
            sLengthMenu: "一次显示 _MENU_ 个数据",
            sLoadingRecords: "加载中...",
            sProcessing: "处理中...",
            sSearch: "搜索:",
            sSearchPlaceholder: "",
            sUrl: "",
            sZeroRecords: "没有搜索到任何信息"
        },
